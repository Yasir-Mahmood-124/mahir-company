      ...
      <Box sx={{  py: 6 }}>
        <Container maxWidth="lg">
          ...
          <Typography variant="body1" sx={{ color: '#777', mb: 5, lineHeight: 1.8 }}>
            UstadonCall Company is Pakistan&apos;s no.1 online marketplace connecting service providers and seekers in a hassle-free and safe way. With our state-of-the-art website, MahiUstadonCall Company App, and UstadonCall Partner App, we are bridging the gap between our customers (consumers and vendors). Now they can connect more efficiently, reliably, safely, and affordably, to enjoy a better living style.
          </Typography>
