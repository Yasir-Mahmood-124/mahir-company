// components/HairStylingHero.tsx
'use client';
...
const HairStylingHero: React.FC = () => {
  return (
    <Box
      component="section"
      sx={{
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Box>
              ...
              >
                Book your area's best hair styling & hair cut services providers at Home.
              </Typography>
          ...
          <Grid item xs={12} md={5}>
            ...
            >
              <Image
                src={Download}
                alt="Hair Styling & Hair Cut Services"
                fill
                priority
                style={{
                  objectFit: 'cover'
...
export default HairStylingHero;