// components/CurtainCleaningBanner.tsx
"use client";
...
const CurtainCleaningBanner: React.FC = () => {
  return (
    <Box
      component="section"
      sx={{
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Box>
              ...
              >
                Book Curtain Cleaning With Us For The Most Reliable, And Efficient Services.
              </Typography>
...
export default CurtainCleaningBanner;