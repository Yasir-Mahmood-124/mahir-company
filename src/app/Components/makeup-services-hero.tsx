// components/MakeupServicesHero.tsx
'use client';
...
const MakeupServicesHero: React.FC = () => {
  return (
    <Box
      component="section"
      sx={{
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Box>
              ...
              >
                Book your area's best makeup services providers at home.
              </Typography>
...
export default MakeupServicesHero;