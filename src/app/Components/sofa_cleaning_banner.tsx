// components/SofaCleaningBanner.tsx
"use client";
...
const SofaCleaningBanner: React.FC = () => {
  return (
    <Box
      component="section"
      sx={{
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Box>
              ...
              >
                Sofa Cleaning & Restoration Services - Don't Replace, Restore it!
              </Typography>
...
export default SofaCleaningBanner;