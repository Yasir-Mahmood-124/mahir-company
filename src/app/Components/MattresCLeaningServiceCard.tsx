...
const MattresCleaningService: React.FC<ACServicesSectionProps> = ({ 
  serviceIds,
  title = "Mattres CLeaning  Services",
  subtitle = "Professional Mattres CLeaning  Services at your home"
}) => {
  const defaultACServiceIds = [213, 234];
