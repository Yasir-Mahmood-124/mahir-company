// components/SolarPanelCleaningBanner.tsx
"use client";
...
const SolarPanelCleaningBanner: React.FC = () => {
  return (
    <Box
      component="section"
      sx={{
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Box>
              ...
              >
                Book Affordable, Reliable, and Speedy Solar Panel Cleaning Services.
              </Typography>
...
export default SolarPanelCleaningBanner;