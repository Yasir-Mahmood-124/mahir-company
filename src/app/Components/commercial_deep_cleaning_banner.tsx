// components/CommercialDeepCleaningBanner.tsx
"use client";
...
const CommercialDeepCleaningBanner: React.FC = () => {
  return (
    <Box
      component="section"
      sx={{
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Box>
              ...
              >
                We Provide You With the Best Commercial Deep Cleaning Services.
              </Typography>
...
export default CommercialDeepCleaningBanner;