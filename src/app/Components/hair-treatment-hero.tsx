// components/HairTreatmentHero.tsx
'use client';
...
const HairTreatmentHero: React.FC = () => {
  return (
    <Box
      component="section"
      sx={{
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Box>
              ...
              >
                Book your area's best hair treatment services providers at home.
              </Typography>
...
export default HairTreatmentHero;