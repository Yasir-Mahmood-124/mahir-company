// components/FacialServicesHero.tsx
'use client';
...
const FacialServicesHero: React.FC = () => {
  return (
    <Box
      component="section"
      sx={{
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Box>
              ...
              >
                Book your area's best facial services providers at Home.
              </Typography>
...
export default FacialServicesHero;