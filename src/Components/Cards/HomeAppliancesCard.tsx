...
interface HomeAppliancesServicesProps {
  serviceIds?: number[];
  title?: string;
  subtitle?: string;
}

const HomeAppliancesServices: React.FC<HomeAppliancesServicesProps> = ({ 
  serviceIds,
  title = "HomeAppliances Services",
  subtitle = "Professional HomeAppliances Services at your home"
}) => {
  const defaultHomeAppliancesServiceIds = [208, 281, 1633, 1654, 1655, 1656];
  const displayServiceIds = serviceIds || defaultHomeAppliancesServiceIds;
