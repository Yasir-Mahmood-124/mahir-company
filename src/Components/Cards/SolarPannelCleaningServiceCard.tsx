// ============================================
// SolarPannelCleaningServiceCard.tsx
// ============================================
'use client';
...
const SolarPanelCleaningServicesSection: React.FC<SolarPanelCleaningServicesSectionProps> = ({ 
  ...
  const filteredServices = products.filter(
    (product) => product.subCategory === "Solar Panel Cleaning Services"
  );
  ...
  if (displayServices.length === 0) {
    return (
      <Box sx={{ py: 6, bgcolor: '#f5f5f5' }}>
        <Container maxWidth="lg">
          <Alert severity="info">No Solar Panel Cleaning Services available at the moment. Add services from the dashboard!</Alert>
        </Container>
      </Box>
    );
  }
