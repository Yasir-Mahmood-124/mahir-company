// components/PlasticTankCleaningBanner.tsx
"use client";
...
const PlasticTankCleaningBanner: React.FC = () => {
  return (
    <Box
      component="section"
      sx={{
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Box>
              ...
              >
                Book the Best Plastic Water Tank Cleaning Experts in the Area Cost-Effectively and Efficiently
              </Typography>
...
export default PlasticTankCleaningBanner;