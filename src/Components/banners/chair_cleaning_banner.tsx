// components/ChairCleaningBanner.tsx
"use client";
...
const ChairCleaningBanner: React.FC = () => {
  return (
    <Box
      component="section"
      sx={{
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={7}>
            <Box>
              ...
              >
                Book Chair Cleaning Services Through Us That You Can Get Done Affordably and More Effectively.
              </Typography>
...
export default ChairCleaningBanner;