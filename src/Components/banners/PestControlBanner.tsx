...
const PestControlBanner: React.FC = () => {
  return (
    <Box
      component="section"
      sx={{
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        ...
        >
          <Box>
            ...
            >
              Book Affordable Pest Control Services at Home - Complete Fumigation Solutions for Residentials & Commercials
            </Typography>
...
export default PestControlBanner;